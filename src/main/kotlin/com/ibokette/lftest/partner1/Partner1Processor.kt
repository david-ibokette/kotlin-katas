package com.ibokette.lftest.partner1
...
@Service
class Partner1Processor(
    private val jdbcTemplate: JdbcTemplate,
) : AbstractPartnerProcessor() {
    var logger: Logger = LoggerFactory.getLogger(Partner1Processor::class.java)
    ...
    override fun processFile(filepath: String, filename: String, partnerId: String) {
        ...
        Files.newBufferedReader(Paths.get(filepath)).use{ reader ->
            val thisList = mutableListOf<Partner1FeedFileRow>()
            CsvToBeanBuilder<Partner1FeedFileRow>(reader)
                .withType(Partner1FeedFileRow::class.java)
    ...
    private fun writeToDatabase(filename: String, partnerId: String, rowList: List<Partner1FeedFileRow>, totalCount: Int) {
